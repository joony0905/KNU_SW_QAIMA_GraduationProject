...
const SCREENER_TOPICS: ScreenerTopic[] = [
  "상승종목",
  "상한가 임박종목",
  "하락종목",
  "상한가 이탈종목",
...
const DEFAULT_STOCKS: StockItem[] = [
  { name: "삼성전자",        symbol: "005930", price: "72,800",  volume: "14,293,826", change: "+800",    changeRate: "+1.11%" },
  { name: "SK하이닉스",      symbol: "000660", price: "189,500", volume: "8,124,310",  change: "+3,500",  changeRate: "+1.88%" },
  { name: "NAVER",           symbol: "035420", price: "182,000", volume: "3,045,720",  change: "-2,500",  changeRate: "-1.36%" },
  { name: "LG에너지솔루션",   symbol: "373220", price: "312,000", volume: "1,204,850",  change: "+5,000",  changeRate: "+1.63%" },
  { name: "삼성바이오로직스", symbol: "207940", price: "856,000", volume: "421,300",    change: "-12,000", changeRate: "-1.38%" },
  { name: "현대차",          symbol: "005380", price: "218,500", volume: "2,381,600",  change: "+2,000",  changeRate: "+0.92%" },
  { name: "셀트리온",        symbol: "068270", price: "178,300", volume: "1,893,420",  change: "-800",    changeRate: "-0.45%" },
  { name: "카카오",          symbol: "035720", price: "43,250",  volume: "5,621,780",  change: "+550",    changeRate: "+1.29%" },
  { name: "POSCO홀딩스",     symbol: "005490", price: "287,000", volume: "934,210",    change: "-4,500",  changeRate: "-1.54%" },
  { name: "기아",            symbol: "000270", price: "96,400",  volume: "3,102,540",  change: "+800",    changeRate: "+0.84%" },
  { name: "LG화학",          symbol: "051910", price: "312,500", volume: "748,630",    change: "+2,500",  changeRate: "+0.81%" },
];
...
export default function StockSearchBar({
  ...
  const [topic, setTopic] = useState<ScreenerTopic>("상승종목");
  ...
  return (
    <section className="grid grid-cols-1 xl:grid-cols-[1.4fr_0.6fr_1fr] gap-3.5 items-start">
      ...
      <div ref={topicRef} className="relative">
        ...
        >
          <span className="text-xs text-ink-3">스크리너</span>
          <span className="flex-1 font-semibold text-base text-ink truncate">{topic}</span>
          {isTopicOpen
          ...
          <div className="absolute w-full bg-surface border border-line border-t-0 rounded-b-xl shadow-pop z-50">
            {SCREENER_TOPICS.map((item) => (
              <button
                ...
                className="w-full text-left px-3.5 py-2.5 text-sm text-ink hover:bg-bg-sunk last:rounded-b-xl"
              >
                {item}
              </button>
            ))}
                ...
                stocks.map((stock) => (
                  ...
                  >
                    <div className="min-w-0 flex-shrink-0">
                      ...
                      <div className="text-[10px] text-ink-3 font-mono mt-0.5 whitespace-nowrap">{stock.symbol} · KOSPI</div>
                    </div>
