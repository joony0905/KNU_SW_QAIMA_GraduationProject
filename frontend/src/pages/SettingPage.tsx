...
export default function SettingPage() {
  ...
  return (
    <div className="min-h-screen bg-bg ml-[84px]">
      <header className="w-full bg-surface border-b border-line px-3 sm:px-4 py-2.5 sm:py-3 flex items-center">
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 flex flex-col gap-8">
        ...
        <div className="flex flex-col items-center gap-4">
          <h2 className="text-xl font-medium text-ink">기본정보</h2>
          <div className="grid grid-cols-[auto_1fr] gap-x-6 gap-y-3 text-base text-ink">
            <span className="text-right border-r border-line pr-5 py-1">
              이름
            </span>
          ...
          <div className="w-full flex justify-end">
            <button
              ...
              className="border border-line rounded-md px-4 py-2 text-sm text-ink hover:bg-bg-sunk"
            >
              개인정보 수정
            </button>
          </div>
        ...
        {/* 투자레벨 */}
        <div className="flex flex-col items-center gap-4">
          <h2 className="text-xl font-medium text-ink">투자레벨</h2>
          <select
            value={investLevel}
            onChange={(e) =>
              setInvestLevel(e.target.value as "초급자" | "중급자" | "고급자")
            }
            className="border border-line rounded px-3 py-2 text-base bg-surface text-ink focus:outline-none"
          >
        ...
        {/* 투자성향 */}
        <div className="flex flex-col items-center gap-4">
          <h2 className="text-xl font-medium text-ink">투자성향</h2>
        ...
        {/* 관심종목 */}
        <div className="flex flex-col items-center gap-4">
          <h2 className="text-xl font-medium text-ink">관심종목</h2>
          <div className="w-full max-h-40 overflow-y-auto border border-line rounded-lg p-3">
            {watchlist.length === 0 ? (
              ...
              <div className="flex flex-wrap gap-2">
                {watchlist.map((item) =>
                  isEditingWatchlist ? (
                    <div
                      key={item}
                      className="flex items-center gap-1 px-2.5 py-1 bg-bg-sunk rounded-full"
                    >
                      ...
                      <button
                        ...
                        className="text-ink-3 hover:text-danger text-xs font-bold ml-1"
                      >
                        ✕
                      </button>
                    </div>
                    ...
                    <span
                      key={item}
                      className="px-2.5 py-1 bg-bg-sunk rounded-full text-sm font-medium text-ink"
                    >
                      {item}
                    </span>
                  ),
        ...
        {/* 언어 */}
        <div className="flex flex-col items-center gap-4">
          <h2 className="text-xl font-medium text-ink">언어/Language</h2>
          <select
            value={language}
            onChange={(e) =>
        ...
        {/* 버그제보 */}
        <div className="flex flex-col items-center gap-4">
          <h2 className="text-xl font-medium text-ink">버그제보</h2>
