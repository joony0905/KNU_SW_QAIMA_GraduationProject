...
CREATE TABLE price_ohlcv (
                             ...
                             CONSTRAINT fk_price_ohlcv_stock
                                 FOREIGN KEY (stock_id) REFERENCES stock(stock_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE indicator_value (
                                 ...
                                 CONSTRAINT fk_indicator_value_stock
                                     FOREIGN KEY (stock_id) REFERENCES stock(stock_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE industry_index_map (
                                    ...
                                    CONSTRAINT fk_industry_index_map_industry
                                        FOREIGN KEY (industry_id) REFERENCES industry(industry_id),
                                    CONSTRAINT fk_industry_index_map_index
                                        FOREIGN KEY (index_id) REFERENCES industry_index(index_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE industry_index_ohlcv (
                                      ...
                                      CONSTRAINT fk_industry_index_ohlcv_index
                                          FOREIGN KEY (index_id) REFERENCES industry_index(index_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE stock_realtime_cache (
                                      ...
                                      CONSTRAINT fk_stock_realtime_cache_stock
                                          FOREIGN KEY (stock_id) REFERENCES stock(stock_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE peer_cluster_cache (
                                    ...
                                    CONSTRAINT fk_peer_cluster_cache_industry
                                        FOREIGN KEY (industry_id) REFERENCES industry(industry_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;